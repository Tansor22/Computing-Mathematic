...
public class ComplexNumber {
    ...
    public static final double EPS = .000_001; // 6 digits
    /**
    ...
    public final boolean equals(Object z) {
        ...
        return inEps(real, a.real) && inEps(imaginary, a.imaginary);
        // TODO PLAIN COMPARING
        // return (real == a.real) && (imaginary == a.imaginary);
    }
    private boolean inEps(double n1, double n2) {
